		...
		<div class="menu_inner menu_mm">
			<div class="menu menu_mm">
				<ul class="menu_list menu_mm">
                    ...
                    <li class="menu_item menu_mm"><a href="Login/logIn.php">Sign In/Sign Up</a></li>
				</ul>
			</div>
				...
				<div class="row">
					...
					<div class="col-lg-4 footer_col">
						<div class="footer_news footer_column">
							...
							<ul>
								<li>
									<div class="footer_news_title"><a href="news.php">Aliquam ac eleifend metus</a></div>
									<div class="footer_news_date">March 10, 2018</div>
								</li>
								<li>
									<div class="footer_news_title"><a href="news.php">Donec in libero sit amet mi vulputate</a></div>
									<div class="footer_news_date">March 10, 2018</div>
								</li>
								<li>
									<div class="footer_news_title"><a href="news.php">Aliquam ac eleifend metus</a></div>
